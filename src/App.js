      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route index element={<News setProgress={this.setProgress} key="world" pageSize={this.pageSize} country={''} category='world' apiKey={this.apiKey}/>} />
            <Route exact path="/top" element={<News setProgress={this.setProgress} key="top" pageSize={this.pageSize} country={this.country} category='top' apiKey={this.apiKey}/>} />
            <Route exact path="/world" element={<News setProgress={this.setProgress} key="world" pageSize={this.pageSize} country={''} category='world' apiKey={this.apiKey}/>} />
            ...
            <Route exact path="/environment" element={<News setProgress={this.setProgress} key="environment" pageSize={this.pageSize} country={this.country} category='environment' apiKey={this.apiKey}/>} />
            <Route exact path="/food" element={<News setProgress={this.setProgress} key="food" pageSize={this.pageSize} country={this.country} category='food' apiKey={this.apiKey}/>} />
            ...
            <Route exact path="/politics" element={<News setProgress={this.setProgress} key="politics" pageSize={this.pageSize} country={this.country} category='politics' apiKey={this.apiKey}/>} />
